...
var obxY=575;
var mouse={
		zhuandongxishu:0.002,
		x_num:0,
		y_num:0,
		
		mousedonghua1:function(){//键盘产生动画
			camera.rotation.set((575-obxY)*mouse.zhuandongxishu,(965-obxX)*mouse.zhuandongxishu,0);//修改角度   
			//camera.rotation.set((575-obxY)*mouse.zhuandongxishu,0,0);//修改角度   
